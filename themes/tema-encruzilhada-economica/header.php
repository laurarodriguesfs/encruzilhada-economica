...
<head>
    ...
    (function() {
        ...
        if (status === 'closed' || isMobile) {
            // Adicionamos no HTML para o CSS ler imediatamente
            document.documentElement.classList.add('menu-is-closed-instant');
        }
    })();
</script>
</head>
	...
	<header id="masthead" class="site-header hide-header-search" [class]="searchVisible ? 'show-header-search site-header ' : 'hide-header-search site-header'">
		...
		<?php else : ?> 
			...
			<div class="middle-header-contain">
				<div class="wrapper">
					...
					<div class="nav-wrapper desktop-only com-search">
		...
		<nav class="mega-menu" id="megaMenu">
			<div class="menu-container">
				...
				<?php 
					wp_nav_menu( array(
						'theme_location' => 'menu_eixos',
						'container'      => false,
						'menu_class'     => 'menu-list ordered'
					) ); 
				?>
				</div>

				<div class="menu-toggle-container">
				<button id="menuToggle" class="btn-toggle">
					<span class="text"> X Esconder menus</span>
				</button>
				</div>
