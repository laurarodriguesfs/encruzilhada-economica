...
<section id="primary" class="content-area">
		...
		<header class="page-header">
			...
			<span>
				...
				<h1 class="page-title">Se não encontrou o que estava procurando, busque aqui:</h1>
		...
		<main id="main" class="site-main">
			<div class="archive-posts-grid">
                ...
                <div class="no-results-container">
                    <h2>Lamentamos, nada foi encontrado.</h2>
                    <p>Não encontramos resultados para essa combinação de filtros ou termo de busca.</p>
                    <p>Tente ajustar a categoria, o autor ou o termo pesquisado.</p>
                </div>

            <?php endif; // Fim do if ( have_posts() ) ?>
				</div>
        </main><?php
